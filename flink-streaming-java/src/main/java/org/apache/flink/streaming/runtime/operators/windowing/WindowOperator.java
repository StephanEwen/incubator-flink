...
public class WindowOperator<K, IN, ACC, OUT, W extends Window>
	...
	protected transient InternalAppendingState<W, IN, ACC> windowState;

	/** The {@link #windowState}, typed to merging state for merging windows.
	 * Null if the window state is not mergeable */
	protected transient InternalMergingState<W, IN, ACC> windowMergingState;

	/** The state that holds the merging window metadata (the sets that describe what is merged) */
	protected transient InternalListState<VoidNamespace, Tuple2<W, W>> mergingSetsState;
