 ...
 */
@Internal
public abstract class BufferStorageImpl implements BufferStorage {

	protected static final Logger LOG = LoggerFactory.getLogger(BufferStorageImpl.class);
	...
	protected BufferStorageImpl(long maxBufferedBytes, String taskName) {
