...
public class ResultPartition implements BufferPoolOwner {
	 ...
	 */
	public ResultSubpartitionView createSubpartitionView(int index, BufferProvider bufferProvider, PipelinedAvailabilityListener availabilityListener) throws IOException {
