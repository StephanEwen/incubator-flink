...
public class LocalInputChannel extends InputChannel implements PipelinedAvailabilityListener {
	...
	private final AtomicInteger numBuffersAvailable;
	...
	LocalInputChannel(
		...
		this(inputGate, channelIndex, partitionId, partitionManager, taskEventDispatcher, 0, 0, metrics);
	}
	...
	LocalInputChannel(
		...
		this.numBuffersAvailable = new AtomicInteger();
	}
	...
	BufferAndAvailability getNextBuffer() throws IOException, InterruptedException {
		...
		int remaining = numBuffersAvailable.decrementAndGet();
	...
	@Override
	public void notifyBuffersAvailable(int numBuffers) {
