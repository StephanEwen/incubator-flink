...
class PipelinedSubpartition extends ResultSubpartition {
	...
	private final ArrayDeque<Buffer> buffers = new ArrayDeque<Buffer>();
	...
	@Override
	public PipelinedSubpartitionView createReadView(BufferProvider bufferProvider) throws IOException {
		final int queueSize;
