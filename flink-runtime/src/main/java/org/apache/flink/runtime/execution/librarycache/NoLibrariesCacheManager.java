...
/**
 * A library cache manager that has no libraries.
 */
public class NoLibrariesCacheManager implements LibraryCacheManager {

	private final ClassLoader classLoader;

	public NoLibrariesCacheManager() {
		this(NoLibrariesCacheManager.class.getClassLoader());
	}

	public NoLibrariesCacheManager(ClassLoader classLoader) {
